...
public class ProduitCatalogue {
    ...
    public ProduitCatalogue(String reference, String libelle, Prix prixAchat, boolean actif, Prix marge, CategorieProduit categorieProduit) {
        this.reference = reference;
        this.libelle = libelle;
        this.prixAchat = prixAchat;
        this.actif = actif;
