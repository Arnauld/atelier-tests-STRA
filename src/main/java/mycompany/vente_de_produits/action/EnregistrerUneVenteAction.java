package mycompany.vente_de_produits.action;

import mycompany.catalogue.exception.ProduitInconnuException;
import mycompany.catalogue.model.ProduitCatalogue;
import mycompany.catalogue.repository.CatalogueProduits;
import mycompany.client.exception.UserInactifException;
import mycompany.client.model.Client;
import mycompany.client.repository.ClientsMagasin;
import mycompany.programme_fidelite.FideliteDao;
import mycompany.programme_fidelite.model.ActionRecompensee;
import mycompany.stocks_produits.repository.StockRepository;
import mycompany.vente_de_produits.model.Commande;
import mycompany.vente_de_produits.model.LigneCommande;
import mycompany.vente_de_produits.model.ProduitVendu;
import mycompany.vente_de_produits.repository.TransactionRepository;
